            ...
            { (compressionPass && breathsPass) ?
                <div>
                    ...
                    <div className="narration">
                        <p>So the pitch is over now. Would you like to check out my long and boring reference list?</p>
                        <div className="story-choices-container">
                            <div className="story-choice active" onClick={()=>{setScene("10")}}>Sure</div>
                            <div className="story-choice active" onClick={()=>{setScene("10")}}>No thanks</div>
                        </div>
                    </div>
                    </FadeIn>
                    <div className="divider"></div>
                        ...
                        <div className="story">
                            <p className="story-text">Just as you were checking the person's vitals, emergency services have arrived and take over - your efforts of CPR has saved a person's life.</p>
