  ...
  return (
    <div className="container">
      ...
      <div className="narration">
        <Typical
          steps={[
            "Every situation is one that can and does happen in reality",
            2000,
          ]}
          loop={1}
          wrapper="p"
      ...
      <FadeIn delay="2500" transitionDuration="1000">
        <div className="story">
          <p className="story-text">
            You start backing away from the situation and so does everyone
            around you. Surely, someone else on the {transport} will do
            something...right?
          </p>
