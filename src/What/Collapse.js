  ...
  return (
    <div className="container">
      {transport === "bus" ? (
        ...
        <div className="tram-background"></div>
      )}
      ...
      <FadeIn delay="3500" transitionDuration="1000">
        <div className="story">
          <p className="story-text">
            You hear a loud thud behind you. Someone has collapsed onto the
            floor. What do you do?
          </p>
          <div className="story-choices-container">
            <div
              className={`story-choice ${isOneActive ? "active" : "inactive"}`}
              onClick={() => {
            ...
            <div
              className={`story-choice ${isTwoActive ? "active" : "inactive"}`}
              onClick={() => {
